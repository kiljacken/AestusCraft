...
public abstract class TileRenderer extends TileEntitySpecialRenderer implements IItemRenderer {
     ...
     * 
     * @param tile
     *            The tile instance we're rendering. {@code null} if rendering
     *            as item
     * @param x
     *            Coordinate on the X-axis to render at
     * @param y
     *            Coordinate on the Y-axis to render at
     * @param z
     *            Coordinate on the Z-axis to render at
     */
