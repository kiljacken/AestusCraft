...
public class BlockInfo {
    ...
    public static int INSULATED_FURNACE_ID = 2502;
    public static final String INSULATED_FURNACE_NAME = "insulatedFurnace";

    public static int HEATED_FLOORING_ID = 2503;
    public static final String HEATED_FLOORING_NAME = "heatedFlooring";
    
    // BuildCraft integration
    public static int FRICTION_HEATER_ID = 2510;
    public static final String FRICTION_HEATER_NAME = "frictionHeater";
    
    public static int ERICSSON_ENGINE_ID = 2511;
    public static final String ERICSSON_ENGINE_NAME = "ericssonEngine";
}
